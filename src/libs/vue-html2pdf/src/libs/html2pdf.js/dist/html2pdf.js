...
/* harmony import */ var _worker_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../worker.js */ "./src/worker.js");
...
/* harmony import */ var html2canvas__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! html2canvas */ "html2canvas");
...
_worker_js__WEBPACK_IMPORTED_MODULE_4__.default.prototype.toPdf = function toPdf() {
  var prereqs = [function checkContainer() {
    return document.body.contains(this.prop.container) || this.toContainer();
  }];
  return this.thenList(prereqs).then( /*#__PURE__*/function () {
    var _toPdf_pagebreak_internal = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var opt, root, pxPageWidth, pxPageHeight, clientBoundingRect, pxFullHeight, nPages, page, options, canvas, imgData;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              opt.html2canvas.windowHeight = pxPageHeight; // Initialize the PDF.

              this.prop.pdf = this.prop.pdf || new jspdf__WEBPACK_IMPORTED_MODULE_5__.jsPDF(opt.jsPDF);
              page = 0;
            ...
            case 13:
              ...
              options = Object.assign({}, opt.html2canvas);
            ...
            case 20:
              ...
              imgData = canvas.toDataURL('image/' + opt.image.type, opt.image.quality);
              this.prop.pdf.addImage(imgData, opt.image.type, opt.margin[1], opt.margin[0], this.prop.pageSize.inner.width, this.prop.pageSize.inner.height);
    ...
    function toPdf_pagebreak_internal() {
      return _toPdf_pagebreak_internal.apply(this, arguments);
    }

    return toPdf_pagebreak_internal;
  }());
};
...
/* harmony import */ var _plugin_ios_pdf_fix_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./plugin/ios-pdf-fix.js */ "./src/plugin/ios-pdf-fix.js");
/* harmony import */ var _plugin_hyperlinks_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./plugin/hyperlinks.js */ "./src/plugin/hyperlinks.js");
