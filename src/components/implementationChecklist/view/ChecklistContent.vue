  ...
  <div>
    <div v-if="!!checklist" :class="!isDashboardView ? 'container' : ''">
      <div class="row">
        ...
        ">
          <div v-for="request in checklist.requests" :key="request.id" class="row">
                ...
                <div class="col-12 col-md-auto">
                  <div :class="$q.screen.gt.sm
                    ...
                    <div class="col-auto q-mb-md">
                      <q-btn v-if="!!checklist && !!checklist.id && (checklist.owner.id === loggedInUser.id || isAdmin)"
                        @click="transferDocument()" color="blue" unelevated class="radius-6 text-weight-600" no-caps
                        outline icon="send" aria-label="transfer document"><q-tooltip anchor="top middle"
                          self="bottom middle" :offset="[10, 10]">
                          {{ $t("transferOwnership") }}
                        </q-tooltip></q-btn>
                    </div>
                    <div class="col-auto q-mb-md">
                      <q-btn @click="exportToPdf()" color="blue" unelevated class="radius-6 text-weight-600" no-caps
                        outline icon="print" aria-label="print document" :loading="watchlistIsLoading"><q-tooltip
                    ...
                    <div class="col-auto q-mb-md">
                      <q-btn @click="addToWatchlist()" color="blue" unelevated class="radius-6 text-weight-600" no-caps
                        outline icon="star_outline" aria-label="bookmark document"
                        :loading="watchlistIsLoading"><q-tooltip anchor="top middle" self="bottom middle"
                          :offset="[10, 10]">
                          {{ $t("bookmark") }}
                        </q-tooltip></q-btn>
                    </div>
                    <div class="col-auto q-mb-md">
                      <q-btn @click="editChecklist()" color="blue" unelevated class="radius-6 text-weight-600" no-caps
                        icon="edit" aria-label="edit document" :loading="editIsLoading">
                        <q-tooltip anchor="top middle" self="bottom middle" :offset="[10, 10]">
                          {{ $t("edit") }}
                        </q-tooltip></q-btn>
                    </div>
                    <div class="col-auto q-mb-md">
                      <q-btn @click="duplicateChecklist()" color="blue" unelevated class="radius-6 text-weight-600"
                        no-caps icon="content_copy" aria-label="duplicate document"
                        :loading="duplicateIsLoading"><q-tooltip anchor="top middle" self="bottom middle"
                          :offset="[10, 10]">
                          {{ $t("duplicate") }}
                        </q-tooltip></q-btn>
                    </div>
                    ...
                    " class="col-auto q-mb-md">
                      <q-btn @click="archiveChecklist()" color="blue" unelevated class="radius-6 text-weight-600"
                        no-caps icon="inventory" aria-label="archive document" :loading="archiveIsLoading">
                        <q-tooltip anchor="top middle" self="bottom middle" :offset="[10, 10]">
                          {{ $t("archive") }}
                        </q-tooltip></q-btn>
                    </div>
                    <div v-if="isAdmin" class="col-auto q-mb-md">
                      <q-btn @click="deleteChecklist()" color="red" unelevated class="radius-6 text-weight-600" no-caps
                        icon="delete" aria-label="delete document" :loading="deleteIsLoading">
                        <q-tooltip anchor="top middle" self="bottom middle" :offset="[10, 10]">
                          {{ $t("delete") }}
                        </q-tooltip></q-btn>
                    </div>
      ...
      <vue-html2pdf :show-layout="false" :float-layout="true" :enable-download="false" :preview-modal="true"
        ...
        @progress="pdfGenerationProgress($event)" ref="html2Pdf">
                      ...
                      <q-card-section>
                        ...
                        <div class="q-ml-md font-16">
                          <div v-if="checklist.editors && checklist.editors.length > 0">
                            <p v-for="(editor, index) in checklist.editors" :key="index" class="q-mb-sm">
                              {{ editor.username }}
                            </p>
                          </div>
                        </div>
                      ...
                      <div class="q-ml-md font-16">
                        <div v-if="checklist.project && checklist.project.id">
                          <a class="q-mb-sm text-blue block text-weight-600 cursor-pointer" target="_blank"
                            rel="noopener noreferrer" @click.prevent="viewProject(checklist.project.id)">{{
                  ...
                  <q-card class="shadow-1 radius-20">
                    <q-card-section v-if="checklist.media">
                      <q-carousel swipeable animated v-model="slide" infinite class="radius-10" autoplay>
                        <q-carousel-slide class="imageStyling" v-for="(item, index) in checklist.media" :key="index"
                      ...
                      <div class="row justify-center">
                        <div class="col-9">
                          <q-tabs swipeable v-model="slide" indicator-color="transparent" outside-arrows inline-label
                            ...
                            <q-tab :name="index + 1" @click="slide = index + 1" v-for="(item, index) in checklist.media"
            ...
            <div class="col-12 q-pt-none">
              <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                          <div class="q-ml-md font-16">
                            ...
                            ">
                              <q-chip v-for="(category, index) in checklist.categories" :key="index" square size="16px"
                        ...
                        <div class="col-12 col-md-8">
                          <div class="q-ml-md font-16">
                            <div v-if="checklist.tags && checklist.tags.length > 0">
                              <q-chip v-for="(tag, index) in checklist.tags" :key="index" square size="16px"
                                color="yellow-10" text-color="blue">
                                {{ tag.title }}
                              </q-chip>
                            </div>
                ...
                " class="col-12 q-mb-md">
                  ...
                  <q-card class="shadow-1 radius-20" :class="checkProgress(
                      ...
                      <div class="row">
                        <div class="col-12 col-md-4">
                          <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                              <p :class="$q.screen.gt.sm ? 'q-mt-sm q-mb-none' : 'q-mb-sm'
                                " class="font-16">
                                {{
                                  dateFormatter(
                                    !!checklist.initialContact &&
                        ...
                        <div class="col-12 col-md-8">
                          <div v-for="(card, propertyName) in checklist.initialContact" :key="card.sortPosition">
                            <div v-if="
                              (propertyName !== 'end' ||
                                propertyName !== 'start' ||
                                propertyName !== 'id') &&
                            ...
                            ">
                              <div class="q-mb-sm" style="background:#16428B1A">
                                <div class="q-pa-md font-16">
                                  <div class="row justify-between items-start q-mb-md">
                                    <div>
                                      <p class="font-18 text-blue text-weight-600 q-ma-none">
                                        {{
                                  ...
                                  <div v-if="!!card.text" class="row items-center q-mb-md">
                                    <div>
                                      <p class="font-16 text-blue-grey-10 q-ma-none">
                                        {{ $t("Description") }}
                                      </p>
                                      <p class="font-16 q-ma-none text-block" v-html="!!card.text ? card.text : ''"></p>
                                    </div>
                                  </div>
                                  <div v-if="propertyName === 'captureIdea'">
                                    <div v-if="card.file && card.file.length > 0" class="row items-center q-mb-none">
                                      <div v-for="(file, index) in card.file" :key="index" class="col-auto q-mr-md">
                                        <a class="q-mb-md text-blue block text-weight-600" target="_blank"
                              ...
                              <div v-if="!!card.tasks && card.tasks.length > 0">
                                <q-expansion-item expand-icon-class="text-blue" v-for="task in card.tasks"
                                  :key="task.sortPosition" style="background:#FDD50033" class="q-mb-sm" default-opened
                                  ...
                                  <q-card>
                                    ...
                                    ">
                                      <div v-for="item in task.children" :key="item.sortPosition">
                                        <q-card-section class="q-pl-none q-py-sm q-pr-none" v-if="item.active === true">
                                          <div class="row">
                                            <div class="col-12">
                                              <div class="row justify-between items-center">
                                                ...
                                                <div class="col-auto">
                                                  <q-checkbox disable color="primary"
                                                    class="isActiveCheckbox font-16 q-py-none" :value="item.active" />
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                  ...
                  <q-card class="shadow-1 radius-20" :class="checkProgress(
                    ...
                    <q-card-section class="q-pa-md items-start q-col-gutter-x-sm">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                          <div v-for="(card, propertyName) in checklist.preparation" :key="card.sortPosition">
                            <div v-if="
                              (propertyName != 'end' ||
                                propertyName != 'start' ||
                                propertyName != 'id') &&
                            ...
                            ">
                              ...
                              <div v-if="!!card.tasks && card.tasks.length > 0">
                                <q-expansion-item expand-icon-class="text-blue" v-for="task in card.tasks"
                                  :key="task.sortPosition" style="background:#FDD50033" class="q-mb-sm"
                                  v-show="task.active === true" default-opened>
                                  <template v-slot:header>
                                    <q-item-section>
                                      <p class="font-18 text-weight-600 q-ma-none">
                                        {{ task.name }}
                                  ...
                                  <q-card>
                                    ...
                                    ">
                                      <div v-for="item in task.children" :key="item.sortPosition">
                                        <q-card-section horizontal class="q-pl-none q-py-sm q-pr-none"
                      ...
                      <div class="row">
                        <div class="col-12 col-md-4">
                          <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                              <p :class="$q.screen.gt.sm ? 'q-mb-sm q-mb-none' : 'q-mt-sm'
                                " class="font-16">
                                {{
                                  dateFormatter(
                                    !!checklist.fundingResearch &&
                        ...
                        <div class="col-12 col-md-8">
                          <div v-for="(card,
                            propertyName) in sortedFundingResearch" :key="card.sortPosition">
                            <div v-if="
                              (propertyName != 'end' ||
                                propertyName != 'start' ||
                                propertyName != 'id') &&
                              ...
                              <div v-if="!!card.tasks && card.tasks.length > 0">
                                <q-expansion-item expand-icon-class="text-blue" v-for="task in card.tasks"
                                  ...
                                  <q-card>
                                    ...
                                    ">
                                      <div v-for="item in task.children" :key="item.sortPosition">
                                        <q-card-section horizontal v-if="item.active === true"
                  ...
                  <q-card :class="checkProgress(
                    ...
                    <q-card-section class="q-pa-md items-start q-col-gutter-x-sm">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                          <div v-for="(card,
                            propertyName) in sortedPreparationOfProject" :key="card.sortPosition">
                            <div v-if="
                              (propertyName != 'end' ||
                                propertyName != 'start' ||
                                propertyName != 'id') &&
                  ...
                  <q-card :class="checkProgress(
                    ...
                    <q-card-section class="q-pa-md items-start q-col-gutter-x-sm">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                          <div v-for="(card, propertyName) in sortedLegitimation" :key="card.sortPosition">
                            <div v-if="
                              (propertyName != 'end' ||
                                propertyName != 'start' ||
                                propertyName != 'id') &&
                  ...
                  <q-card :class="checkProgress(
                    ...
                    <q-card-section class="q-pa-md items-start q-col-gutter-x-sm">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                          <div v-for="(card,
                            propertyName) in sortedFinalExamination" :key="card.sortPosition">
                            <div v-if="
                              (propertyName != 'end' ||
                                propertyName != 'start' ||
                                propertyName != 'id') &&
                  ...
                  <div class="row">
                    <div class="col-12 col-md-4">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                          <p :class="$q.screen.gt.sm ? 'q-mb-none' : 'q-mb-sm'
                            " class="font-16">
                            {{
                              dateFormatter(
                                !!checklist.preparation &&
    ...
    <RequestAccessDialog :id="itemId" :tab="tab" :type="type" :dialogState="requestDialog" @update="
      ...
      " />
    <DocumentTransferDialog v-if="!!checklist && !!checklist.id && (checklist.owner.id === loggedInUser.id || isAdmin)"
      :id="itemId" type="checklist" :dialogState="documentTransferDialog"
