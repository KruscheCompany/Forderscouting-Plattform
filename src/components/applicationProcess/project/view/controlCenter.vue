          ...
          <div class="col-12 col-md-auto">
            <div :class="$q.screen.gt.sm
              ...
              <div class="col-auto q-mb-sm">
                <q-btn v-if="!!project && !!project.id && (project.owner.id === loggedInUser.id || isAdmin)"
                  @click="transferDocument()" color="blue" unelevated class="radius-6 text-weight-600" no-caps outline
                  icon="send" aria-label="Transfer Ownership"><q-tooltip anchor="top middle" self="bottom middle"
                    :offset="[10, 10]">
                    {{ $t("transferOwnership") }}
                  </q-tooltip></q-btn>
              </div>
              <div class="col-auto q-mb-md">
                <q-btn @click="exportToPdf()" color="blue" unelevated class="radius-6 text-weight-600" no-caps outline
                  icon="print" aria-label="Print" :loading="watchlistIsLoading"><q-tooltip anchor="top middle"
              ...
              <div class="col-auto q-mb-md">
                <q-btn @click="editProject()" color="blue" unelevated class="radius-6 text-weight-600" no-caps
                  icon="edit" aria-label="Edit" :loading="editIsLoading">
              ...
              <div class="col-auto q-mb-md">
                <q-btn @click="duplicateProject()" color="blue" unelevated class="radius-6 text-weight-600" no-caps
                  icon="content_copy" aria-label="Duplicate" :loading="duplicateIsLoading"><q-tooltip
                    anchor="top middle" self="bottom middle" :offset="[10, 10]">
                    {{ $t("duplicate") }}
                  </q-tooltip></q-btn>
              </div>
              ...
              " class="col-auto q-mb-md">
                <q-btn @click="archiveProject()" color="blue" unelevated class="radius-6 text-weight-600" no-caps
              ...
              <div v-if="isAdmin" class="col-auto q-mb-md">
                <q-btn @click="deleteProject()" color="red" unelevated class="radius-6 text-weight-600" no-caps
